  ...
  return (
    <div className="bg-gradient-to-b from-surface-50 to-background dark:from-surface-900 dark:to-background px-3 sm:px-6 py-4 sm:py-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div
          className="flex items-center gap-2 sm:gap-3 bg-card rounded-xl border-2 border-border p-2 focus-within:border-blue-500/50 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all shadow-sm"
        ...
        >
          ...
          <textarea
            ...
            rows={1}
            className="flex-1 bg-transparent text-base md:text-sm text-foreground placeholder-muted-foreground/50 resize-none focus:outline-none px-3 py-2 max-h-[200px] leading-relaxed"
          />
